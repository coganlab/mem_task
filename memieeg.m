...
% The inputs are:
% subject: Needs to be a string like this 'S01'
...
name2save = [subID '_Block_0' int2str(blockID) '_' time '.csv'];
...
block_file = fullfile(block_data,subID, [subID '_0' int2str(blockID) '.csv']);
